...
class InspectableBase abstract : public I...
{
public:
    InspectableBase()
    {
    ...
    InspectableBase(const InspectableBase&) = delete;
    InspectableBase& operator=(const InspectableBase&) = delete;
    InspectableBase(InspectableBase&&) = delete;
    InspectableBase& operator=(InspectableBase&&) = delete;
...
template<TrustLevel level, typename... I>
class InspectableElementBase abstract : public I...
{
public:
    InspectableElementBase()
    {
        DllAddRef();
    }

    InspectableElementBase(const InspectableElementBase&) = delete;
    InspectableElementBase& operator=(const InspectableElementBase&) = delete;
    InspectableElementBase(InspectableElementBase&&) = delete;
    InspectableElementBase& operator=(InspectableElementBase&&) = delete;
    ...
    virtual ~InspectableElementBase()
    {
        DllRelease();
    }
